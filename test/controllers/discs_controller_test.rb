...
class DiscsControllerTest < ActionController::TestCase
  ...
  test "should create disc" do
    assert_difference('Disc.count') do
      post :create, disc: { brand: @disc.brand, color: @disc.color, course_id: @disc.course_id, day_lost: @disc.day_lost, hole_id: @disc.hole_id, name: @disc.name, user_id: @disc.user_id }
    end
  ...
  test "should update disc" do
    patch :update, id: @disc, disc: { brand: @disc.brand, color: @disc.color, course_id: @disc.course_id, day_lost: @disc.day_lost, hole_id: @disc.hole_id, name: @disc.name, user_id: @disc.user_id }
    assert_redirected_to disc_path(assigns(:disc))
  end
